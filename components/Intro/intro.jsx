    ...
    return(
        <section id="intro">
            <div className="introContent">
                ...
                <div className="introPara">I'm a passionate software engineering student with a strong foundation in coding,
                 <br/>    problem-solving, and building innovative solutions.</div>
